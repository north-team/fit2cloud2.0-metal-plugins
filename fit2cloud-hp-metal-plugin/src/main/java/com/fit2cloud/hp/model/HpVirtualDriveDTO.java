...
public class HpVirtualDriveDTO {
     ...
     * log_drive_arrays : [{"storage_type":"SMART_ARRAY_CONTROLLER_TYPE","name":"Controller on System Board","status":"OP_STATUS_OK","hw_status":"OP_STATUS_OK","serial_no":"PDNLH0BRH9B44R","model":"Smart Array P440ar Controller","fw_version":"7.00","accel_cond":"OP_STATUS_OK","accel_serial":"PDNLH0BRH9B44R","accel_tot_mem":"2097152 KB","has_accel":1,"encr_stat":"ENCR_NOT_ENABLED","encr_self_stat":"OP_STATUS_OK","encr_csp_stat":"OP_STATUS_OK","has_encrypt":1,"logical_drives":[{"name":"Logical Drive 01","status":"OP_STATUS_OK","capacity":"1862 GB","log_status":"LOG_OK","flt_tol":"RAID 0","lu_cache_flag":"LOG_CACHE_FLAG_NONMEMBER","lu_cache_LUN":"HIDDEN","encr_stat":"ENCR_NOT_ENCR","physical_drives":[0,1,2,3]}],"enclosures":[{"name":"Drive Enclosure Port 1I Box 3","status":"OP_STATUS_OK","ports":"4"},{"name":"Drive Enclosure Port 2I Box 0","status":"OP_STATUS_OK","ports":"4"}]}]
     */
    ...
    public static class LogDriveArraysBean {
         ...
         * has_encrypt : 1
         * logical_drives : [{"name":"Logical Drive 01","status":"OP_STATUS_OK","capacity":"1862 GB","log_status":"LOG_OK","flt_tol":"RAID 0","lu_cache_flag":"LOG_CACHE_FLAG_NONMEMBER","lu_cache_LUN":"HIDDEN","encr_stat":"ENCR_NOT_ENCR","physical_drives":[0,1,2,3]}]

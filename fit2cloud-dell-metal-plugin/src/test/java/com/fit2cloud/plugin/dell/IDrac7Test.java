...
import com.fit2cloud.plugin.dell.model.idrac7.DellIDrac7CpuDTO;
import com.fit2cloud.plugin.dell.model.idrac7.DellIDrac7DiskDTO;
import com.fit2cloud.plugin.dell.model.idrac7.DellIDrac7MemoryDTO;
import com.fit2cloud.plugin.dell.utils.IDrac6RestSpider;
import com.fit2cloud.plugin.dell.utils.IDrac7HWUtils;
...
public class IDrac7Test {
    ...
    private static boolean tryIDrac7API(String ip, MachineEntity machineEntity) throws JAXBException, JDOMException, IOException {
        ...
        List<F2CPmCpu> cpuDTOS = new LinkedList<>();
        List<F2CPmMemory> memoryDTOS = new LinkedList<>();

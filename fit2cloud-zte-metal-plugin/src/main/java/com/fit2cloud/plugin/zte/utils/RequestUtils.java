package com.fit2cloud.plugin.zte.utils;
...
public class RequestUtils {
    ...
    public static void idrac6SetHeaders(String ip, Header[] cookies, Map<String, String> headers) {
        LogUtil.info(String.format("爬取zte idrac6 %s登录接口返回Header：%s", JSONObject.toJSONString(cookies)));
        String responseCookie = getCookie(cookies, "Set-Cookie", "SET-COOKIE");
        LogUtil.info(String.format("爬取zte idrac6 %s登录接口最终Cookie：%s", ip, responseCookie));
